...
class SILoss:
    ...
    def __call__(self, model, images, raw_image, model_kwargs=None, zs=None):
        ...
        model_output, zs_tilde = model(x = model_input, t=time_input.flatten(),condition=condition, **model_kwargs)
        ...
        for i, (z, z_tilde) in enumerate(zip(zs, zs_tilde)):
            ...
            # print(z.shape,z_tilde.shape,'++++')
            proj_loss += torch.nn.MSELoss()(z, z_tilde)
